...
namespace ParkeoApp.Api.Controllers
{
	...
	{
		[HttpGet]
		[ProducesResponseType<ApiResponse<GetRole>>(StatusCodes.Status200OK)]
		...
		[HttpGet("{id:guid}")]
		[ProducesResponseType<ApiResponse<GetRole>>(StatusCodes.Status200OK)]
		[ProducesResponseType<ApiResponse<GetRole>>(StatusCodes.Status404NotFound)]
		...
		[HttpPost]
		[ProducesResponseType<ApiResponse<GetRole>>(StatusCodes.Status201Created)]
		[ProducesResponseType<ApiResponse<GetRole>>(StatusCodes.Status400BadRequest)]
		public async Task<IActionResult> CreateAsync([FromHeader(Name = "Authorization")] string jwt, [FromBody] AddRole model)
		{
		...
		public async Task<IActionResult> UpdateAsync([FromHeader(Name = "Authorization")] string jwt, [FromRoute] Guid id, [FromBody] AddRole model)
		{
